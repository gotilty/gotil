...
func TestConvertToFloat64(t *testing.T) {
	...
	for key, test := range testData {
		...
		b, errb := converter.ToFloat64(test.inputValue)
		if erra == nil {
			if a != b || errb != nil {
...
func BenchmarkConvertToFloat64String(b *testing.B) {
	testData := getConvertToFloat64TestData()
	for n := 0; n < b.N; n++ {
		converter.ToFloat64(testData["string"].inputValue)
	}
}
func BenchmarkConvertToFloat64Integer(b *testing.B) {
	testData := getConvertToFloat64TestData()
	for n := 0; n < b.N; n++ {
		converter.ToFloat64(testData["integer"].inputValue)
	}
}
...
func BenchmarkConvertToFloat64Struct(b *testing.B) {
	testData := getConvertToFloat64TestData()
	for n := 0; n < b.N; n++ {
		converter.ToFloat64(testData["struct"].inputValue)
	}
}
func BenchmarkConvertToFloat64Uint(b *testing.B) {
	testData := getConvertToFloat64TestData()
	for n := 0; n < b.N; n++ {
		converter.ToFloat64(testData["uint"].inputValue)
	}
}
